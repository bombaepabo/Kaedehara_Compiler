    ...
    public sealed class SourceText
    {
      private SourceText(string text){
        ...
        private static void Addline(ImmutableArray<TextLine>.Builder result, SourceText sourceText, int position, int lineStart, int lineBreakWidth)
        {
            ...
            var lineLengthIncludingLineBreakwidth = lineLength + lineBreakWidth;
            var line = new TextLine(sourceText, lineStart, lineLength, lineLengthIncludingLineBreakwidth);
            result.Add(line);
